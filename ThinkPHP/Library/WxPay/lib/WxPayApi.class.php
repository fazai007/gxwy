...
class WxPayApi {
     ...
     * appid、mchid、spbill_create_ip、nonce_str不需要填入
     * @param \WxPay\database\WxPayCloseOrder $inputObj
     * @param int $timeOut
     * @throws WxPayException
     ...
     * appid、mchid、spbill_create_ip、nonce_str不需要填入
     * @param \WxPay\database\WxPayRefund $inputObj
     * @param int $timeOut
     * @throws WxPayException
     * @return array 成功时返回，其他抛异常
     */
     ...
     * appid、mchid、spbill_create_ip、nonce_str不需要填入
     * @param \WxPay\database\WxPayRefundQuery $inputObj
     * @param int $timeOut
     * @throws WxPayException
     * @return array 成功时返回，其他抛异常
     */
     ...
     * appid、mchid、spbill_create_ip、nonce_str不需要填入
     * @param \WxPay\database\WxPayDownloadBill $inputObj
     * @param int $timeOut
     * @throws WxPayException
     * @return array 成功时返回，其他抛异常
     */
     ...
     * appid、mchid、spbill_create_ip、nonce_str不需要填入
     * @param \WxPay\database\WxPayMicroPay $inputObj
     * @param int $timeOut
     * @return array
     * @throws WxPayException
     */
     ...
     * appid、mchid、spbill_create_ip、nonce_str不需要填入
     * @param \WxPay\database\WxPayReverse $inputObj
     * @param int $timeOut
     * @return array
     * @throws WxPayException
     */
     ...
     * appid、mchid、spbill_create_ip、nonce_str不需要填入
     * @param \WxPay\database\WxPayReport $inputObj
     * @param int $timeOut
     * @throws WxPayException
     * @return array 成功时返回，其他抛异常
     */
     ...
     * 生成二维码规则,模式一生成支付二维码
     * appid、mchid、spbill_create_ip、nonce_str不需要填入
     * @param \WxPay\database\WxPayBizPayUrl $inputObj
     * @throws WxPayException
     * @return array 成功时返回，其他抛异常
     */
    ...
    private static function reportCostTime($url, $startTimeStamp, $data) {
        ...
        //如果仅失败上报
        if (WxPayConfig::getConfig('REPORT_LEVENL') == 1 && array_key_exists("return_code", $data) && $data["return_code"] == "SUCCESS" && array_key_exists("result_code", $data) && $data["result_code"] == "SUCCESS") {
            return;
        }
        //上报逻辑
    ...
    private static function postXmlCurl($xml, $url, $useCert = false, $second = 30) {
        ...
        //如果有配置代理这里就设置代理
        if (WxPayConfig::getConfig('CURL_PROXY_HOST') != "0.0.0.0" && WxPayConfig::getConfig('CURL_PROXY_PORT') != 0) {
