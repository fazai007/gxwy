...
class CollectModel extends Model
{
     ...
     * @todo 修改模型信息
     */
    public function editCollect($where='',$arr)
    {
     ...
     * @todo isuse设为1 || 真删除
     */
    public function delCollect($collect_id,$opt = false)
    {
     ...
     */
    public function getCollectList($fields = '', $where = '', $orderby = '', $group = '')
    {
     ...
     * @return void
     */
    public function getCollectField($where,$field)
    {
     ...
     * @todo 根据传入的$Collect_list获取更详细的模型列表页数据信息列表
     */
     ...
     * @todo 根据SQL查询字句查询模型信息
     */
    public function getAllCollect($fields = '', $where = '', $orderby = '', $group = '')
    {
