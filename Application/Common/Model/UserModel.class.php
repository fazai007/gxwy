...
class UserModel extends Model
{
     ...
     * @todo 修改模型信息
     */
    public function editUser($where='',$arr)
    {
     ...
     * @todo isuse设为1 || 真删除
     */
    public function delUser($user_id,$opt = false)
    {
        ...
        if($opt)
        {
           ...
           return $this->where('user_id = ' . $user_id)->save(array('isuse' => 2)); 
        }
     ...
     */
    public function getUserList($fields = '', $where = '', $orderby = '', $group = '')
    {
     ...
     * @todo 根据传入的$User_list获取更详细的模型列表页数据信息列表
     */
     ...
     * @todo 根据SQL查询字句查询模型信息
     */
    public function getAllUser($fields = '', $where = '', $orderby = '', $group = '')
    {
